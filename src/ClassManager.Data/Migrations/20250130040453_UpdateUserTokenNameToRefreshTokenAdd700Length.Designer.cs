...
namespace ClassManager.Data.Migrations
{
    ...
    [Migration("20250130040453_UpdateUserTokenNameToRefreshTokenAdd700Length")]
    partial class UpdateUserTokenNameToRefreshTokenAdd700Length
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassManager.Domain.Contexts.Accounts.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClassManager.Domain.Contexts.Invoices.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClassManager.Domain.Contexts.Accounts.Entities.UserToken", b =>
                {
                    b.HasOne("ClassManager.Domain.Contexts.Accounts.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("ClassManager.Domain.Contexts.Accounts.Entities.UserToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ClassManager.Domain.Contexts.Invoices.Entities.Payment", b =>
                {
                    b.HasOne("ClassManager.Domain.Contexts.Invoices.Entities.Invoice", "Invoice")
                        .WithOne("Payment")
                        .HasForeignKey("ClassManager.Domain.Contexts.Invoices.Entities.Payment", "InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade);
