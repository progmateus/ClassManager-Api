...
public interface IBookingRepository : IRepository<Booking>
{
  ...
  Task<List<Booking>> ListByUserIdAndTenantIdWithPagination(Guid? tenantId, Guid userId, string search = "", int skip = 0, int limit = 30, CancellationToken cancellationToken = default);
}