...
public class DeleteTenantInvoiceHandler : ITenantDeleteAction
{
  private ITenantInvoiceRepository _tenantInvoiceRepository;
  private readonly IAccessControlService _accessControlService;

  public DeleteTenantInvoiceHandler(
  ...
  public async Task<ICommandResult> Handle(Guid loggedUserId, Guid tenantId, Guid invoiceId)
  {
    ...
    await _tenantInvoiceRepository.DeleteAsync(invoiceId, tenantId, new CancellationToken());
