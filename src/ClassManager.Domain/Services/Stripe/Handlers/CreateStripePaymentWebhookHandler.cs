...
public class CreateStripePaymentWebhookHandler
{
  ...
  public async Task Handle(Invoice? stripeInvoice)
  {
    ...
    var amount = stripeInvoice.Total / 100;

    var payment = new Contexts.Invoices.Entities.Payment(amount, stripeInvoice.Currency, invoiceEntity.TenantId, invoiceEntity.Id, invoiceEntity.TargetType);
